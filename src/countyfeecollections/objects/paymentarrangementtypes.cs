...
namespace county.feecollections
{
    ...
    public class PaymentArrangementTypes : BaseCollection<PaymentArrangementType>
    {


        #region public PaymentArrangementTypes() : base()
        public PaymentArrangementTypes() : base()
        {

            BuildPaymentArrangementTypeList();

        }
        #endregion

        #region private void BuildPaymentArrangementTypeList()
